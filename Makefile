...
FILES		= main color intersect debug vector init utils keypress parse ft_split_charset parse_control init_scene ft_atof init_objs math math2 draw free free_objs
